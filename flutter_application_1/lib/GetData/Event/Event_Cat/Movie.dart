...
class EventMovie extends StatefulWidget {
  const EventMovie({super.key});

  @override
  State<EventMovie> createState() => _EventMovieState();
}

class _EventMovieState extends State<EventMovie> {
  @override
    ...
    return Center(
      child: Container(
        child: StreamBuilder<QuerySnapshot>(
          stream:
              _service.post12.where('category', isEqualTo: 'Movie').snapshots(),
          builder:
