...
class EventSport extends StatefulWidget {
  const EventSport({super.key});

  @override
  State<EventSport> createState() => _EventSportState();
}

class _EventSportState extends State<EventSport> {
  @override
    ...
    return Center(
      child: Container(
        child: StreamBuilder<QuerySnapshot>(
          stream:
              _service.post12.where('category', isEqualTo: 'Sport').snapshots(),
          builder:
