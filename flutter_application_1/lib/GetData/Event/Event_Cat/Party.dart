...
class EventParty extends StatefulWidget {
  const EventParty({super.key});

  @override
  State<EventParty> createState() => _EventPartyState();
}

class _EventPartyState extends State<EventParty> {
  @override
    ...
    return Center(
      child: Container(
        child: StreamBuilder<QuerySnapshot>(
          stream:
              _service.post12.where('category', isEqualTo: 'Party').snapshots(),
          builder:
