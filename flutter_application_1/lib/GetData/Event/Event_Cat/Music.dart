...
class EventMusic extends StatefulWidget {
  const EventMusic({super.key});

  @override
  State<EventMusic> createState() => _EventMusicState();
}

class _EventMusicState extends State<EventMusic> {
  @override
    ...
    return Center(
      child: Container(
        child: StreamBuilder<QuerySnapshot>(
          stream:
              _service.post12.where('category', isEqualTo: 'Music').snapshots(),
          builder:
