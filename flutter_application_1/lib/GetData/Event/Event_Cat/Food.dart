...
class EventFood extends StatefulWidget {
  const EventFood({super.key});

  @override
  State<EventFood> createState() => _EventFoodState();
}

class _EventFoodState extends State<EventFood> {
  @override
    ...
    return Center(
      child: Container(
        child: StreamBuilder<QuerySnapshot>(
          stream:
              _service.post12.where('category', isEqualTo: 'Food').snapshots(),
          builder:
