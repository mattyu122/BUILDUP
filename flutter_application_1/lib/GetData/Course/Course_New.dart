...
class CourseNEW extends StatefulWidget {
  const CourseNEW({super.key});

  @override
  State<CourseNEW> createState() => _CourseNEWState();
}

class _CourseNEWState extends State<CourseNEW> {
  @override
