...
class CourseArt extends StatefulWidget {
  const CourseArt({super.key});

  @override
  State<CourseArt> createState() => _CourseArtState();
}

class _CourseArtState extends State<CourseArt> {
  @override
    ...
    return Center(
      child: Container(
        child: StreamBuilder<QuerySnapshot>(
          stream:
              _service.Cpost.where('faculty', isEqualTo: 'Arts').snapshots(),
          builder:
