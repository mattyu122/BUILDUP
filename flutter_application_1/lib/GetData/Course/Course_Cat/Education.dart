...
class CourseEducation extends StatefulWidget {
  const CourseEducation({super.key});

  @override
  State<CourseEducation> createState() => _CourseEducationState();
}

class _CourseEducationState extends State<CourseEducation> {
  @override
    ...
    return Center(
      child: Container(
        child: StreamBuilder<QuerySnapshot>(
          stream: _service.Cpost.where('category', isEqualTo: 'Education')
              .snapshots(),
          builder:
