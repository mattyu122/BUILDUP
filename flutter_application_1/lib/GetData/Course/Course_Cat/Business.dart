...
class CourseBusiness extends StatefulWidget {
  const CourseBusiness({super.key});

  @override
  State<CourseBusiness> createState() => _CourseBusinessState();
}

class _CourseBusinessState extends State<CourseBusiness> {
  @override
    ...
    return Center(
      child: Container(
        child: StreamBuilder<QuerySnapshot>(
          stream: _service.Cpost.where('category', isEqualTo: 'Business')
              .snapshots(),
          builder:
