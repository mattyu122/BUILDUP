...
class CourseScience extends StatefulWidget {
  const CourseScience({super.key});

  @override
  State<CourseScience> createState() => _CourseScienceState();
}

class _CourseScienceState extends State<CourseScience> {
  @override
    ...
    return Center(
      child: Container(
        child: StreamBuilder<QuerySnapshot>(
          stream:
              _service.Cpost.where('faculty', isEqualTo: 'Science').snapshots(),
          builder:
