...
class CourseLaw extends StatefulWidget {
  const CourseLaw({super.key});

  @override
  State<CourseLaw> createState() => _CourseLawState();
}

class _CourseLawState extends State<CourseLaw> {
  @override
