...
class CourseMedicine extends StatefulWidget {
  const CourseMedicine({super.key});

  @override
  State<CourseMedicine> createState() => _CourseMedicineState();
}

class _CourseMedicineState extends State<CourseMedicine> {
  @override
